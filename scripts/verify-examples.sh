...
rust-hello)     check_dry_run "$dir" "check cargo installed" "cargo build" ;;
    ...
    orm-typeorm)    check_dry_run "$dir" "check npm installed" "npm install" "typeorm migration:run" ;;
    orm-sequelize)  check_dry_run "$dir" "check npm installed" "npm install" "sequelize-cli db:migrate" ;;
    orm-knex)       check_dry_run "$dir" "check npm installed" "npm install" "knex migrate:latest" ;;
    dotnet-ef)      check_dry_run "$dir" "check dotnet installed" "dotnet restore" "dotnet ef database update" ;;
